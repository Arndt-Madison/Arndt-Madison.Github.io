import { loadHeaderFooter, HF_main } from "/assets/js/HeaderFooter.js";
import { loadBranch } from "/assets/js/OpenJsons.js";
...
async function main(){
	...
	const cardData = await loadBranch("BusinessCard");
